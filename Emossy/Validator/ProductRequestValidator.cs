...
namespace Emossy.Validator
{
    public class CreateProductValidator : AbstractValidator<Req.CreateProduct>
    {
    ...
    public class EditProductValidator : AbstractValidator<Req.EditProduct>
    {
    ...
    public class ProductValidator : AbstractValidator<Req.ProductById>
    {
    ...
    public class DeleteProductValidator : AbstractValidator<Req.ProductById>
    {
